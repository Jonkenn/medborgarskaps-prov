...
import { nyheterDocs, nyheterMeta } from "@/.source";
import { ThemeToggle } from "@/components/theme-toggle";
import { formatDate } from "@/lib/utils";

const nyheterSource = loader({
  baseUrl: "/nyheter",
  source: createMDXSource(nyheterDocs, nyheterMeta),
});
...
export default function NyheterPage() {
  const allPages = nyheterSource.getPages() as ChangelogPage[];
      ...
      <div className="border-b border-border/50">
        <div className="max-w-5xl mx-auto relative">
          <div className="p-3 flex items-center justify-between">
            <h1 className="text-3xl font-semibold tracking-tight">Nyheter & tidslinje: från språkkrav till medborgarskapstest</h1>
            <ThemeToggle />
          </div>
        </div>
      </div>
